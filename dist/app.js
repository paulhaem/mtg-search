...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function index(){$app.html((0,_home2.default)())}function notFound(){$app.html((0,_notFound2.default)())}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_page=require("page"),_page2=_interopRequireDefault(_page),_runtime=require("hbsfy/runtime"),_runtime2=_interopRequireDefault(_runtime),_home=require("./templates/home.hbs"),_home2=_interopRequireDefault(_home),_notFound=require("./templates/not-found.hbs"),_notFound2=_interopRequireDefault(_notFound),$app=(0,_jquery2.default)("#app");(0,_page2.default)("/",index),(0,_page2.default)("*",notFound),(0,_page2.default)();

},{"./templates/home.hbs":25,"./templates/not-found.hbs":26,"hbsfy/runtime":20,"jquery":21,"page":22}],25:[function(require,module,exports){
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[7,">= 4.0.0"],main:function(e,r,n,i,l){return"<h2>Home</h2>\n<p>Willkommen, willkomen. Hereinspaziert.</p>\n"},useData:!0});

},{"hbsfy/runtime":20}],26:[function(require,module,exports){
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[7,">= 4.0.0"],main:function(e,r,i,n,a){return"<h2>404 Not Found</h2>\n<p>Nicht sehr viel hier…</p>\n"},useData:!0});
